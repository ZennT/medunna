...
Feature:test all registrant data
  ...
  @UIHome
  Scenario Outline: US001_01_TC_0001-04-06 test multiple test data for registrant positive test
  ...
  @UIRegistration
  Scenario Outline: US_001_TC_0002 register with invalid ssn
  ...
  @UIRegistration
  Scenario Outline: US_003_TC_0003 user should not enter the characters more than the specified range password
  ...
  @UIRegistration
  Scenario: US_003_TC_0004 register with blank password
    Given user leaves password blank and press enter
    And verify your password is required visible

  @UIRegistration
  Scenario Outline:US_003_TC_0005-6-7-8-9  Password at least 7 characters long and contains two different char for a stronger password
    Given user provides the new password "<password>"
...
#      |2222 2222  |2              |
  ...
  @UIRegistration
  Scenario: US_003_TC_0011 register with blank confirmation password
  ...
  @UIRegistration
  Scenario Outline:US_003_TC_0012 test password confirmation negative
    Given user provides the new password "<password>"
    And user provides the password confirmation "<passwordConfirmation>"
  ...
  @UIRegistration
  Scenario Outline: US_003_TC_0013 register with invalid password confirmation password
    And user provides the password confirmation "<passwordConfirmation>"
  ...
  @UIRegistration
  Scenario Outline: US_003_TC_0015 test multiple test data for registrant ssn validation
